...
namespace Cesil.Benchmark.Benchmarks
{
    ...
    public class BigWrite
    {
        ...
        private static readonly BoundConfiguration<Row> Config = Configuration.For<Row>(Options.Default.NewBuilder().WithWriteTrailingNewLine(WriteTrailingNewLines.Always).Build());
