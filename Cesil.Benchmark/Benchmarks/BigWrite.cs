...
namespace Cesil.Benchmark.Benchmarks
{
    ...
    public class BigWrite
    {
        ...
        private static readonly IBoundConfiguration<Row> Config = Configuration.For<Row>(Options.CreateBuilder(Options.Default).WithWriteTrailingRowEnding(WriteTrailingRowEnding.Always).ToOptions());
