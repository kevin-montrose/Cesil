...
namespace Cesil.Tests
{
    public class PipeReaderAdapterTests
    {
        ...
        // todo: this test isn't reliable and so has been disabled
        //       it randomly fails to make progress, which is no good
        //       would be nice to either rework it or convince ourselves
        //       it isn't needed
